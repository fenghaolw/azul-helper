...
def start_api_server(port=5000, kill_existing=False, agent_type='auto', background=False):
...
def main():
    ...
    parser.add_argument('--ui-only', '-u', action='store_true',
    ...
    parser.add_argument('--agent-type', '-a', choices=['auto', 'mcts', 'heuristic'],
                       default='auto', help='Agent type (default: auto)')
