...
from azul_rl.game.game_state import GameState  # noqa: E402,I100
from azul_rl.game.pettingzoo_env import AzulAECEnv  # noqa: E402
from azul_rl.game.state_representation import AzulStateRepresentation  # noqa: E402
from azul_rl.training.neural_network import create_azul_network  # noqa: E402
...
def test_different_network_configurations():
    ...
    from azul_rl.game.state_representation import AzulStateRepresentation
