...
flags.DEFINE_float("uct_c", 1.0, "UCT exploration constant")
...
flags.DEFINE_integer("temperature_drop", 15, "Move when temperature drops")
flags.DEFINE_string("nn_model", "mlp", "Neural network architecture (mlp, resnet)")
